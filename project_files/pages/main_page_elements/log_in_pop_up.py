...
from project_files.pages.main_page_elements.registration_pop_up import RegistrationPopUp
from project_files.pages.main_page_elements.restore_access_pop_up import RestoreAccessPopUp
