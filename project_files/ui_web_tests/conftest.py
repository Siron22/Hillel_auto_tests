...
from project_files.pages.navigation_elements.sidebar import Sidebar
from project_files.utilities.browsers import Browser
from project_files.utilities.useful_func import get_browser_name, get_screenshot_directory
from project_files.utilities.project_exceptions import UnsupportedBrowserError
...
@pytest.fixture(scope='session')
def registered_user():
    return User(name='Pierce', lastname='Nicolass', email='Shany.Windler@gmail.com', password='Wednesday1XxXx')
